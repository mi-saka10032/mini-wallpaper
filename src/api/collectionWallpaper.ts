...
export async function addWallpapers(collectionId: number, wallpaperIds: number[]): Promise<number> {
  return invoke(COMMANDS.ADD_WALLPAPERS_TO_COLLECTION, {
    collectionId,
    wallpaperIds,
  });
}
...
export async function removeWallpapers(
  ...
  return invoke(COMMANDS.REMOVE_WALLPAPERS_FROM_COLLECTION, {
    collectionId,
    wallpaperIds,
  });
}
...
export async function reorderWallpapers(
  ...
  return invoke(COMMANDS.REORDER_COLLECTION_WALLPAPERS, {
    collectionId,
    wallpaperIds,
  });
}
